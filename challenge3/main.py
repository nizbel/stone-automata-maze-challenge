...
if __name__ == '__main__':
    ...
    # Removed individuality usage because not using it found a shorter path
    # # Use individuality to change up to 30 cells in the diagonal between start and finish
    # usages = 0
    # usage_record = []
    # for i in range(map_rows):
    #     # Considering the map is a 2000x2000 square, just search diagonally
    #     if not check_position_walkable((i, i)):
    #         usages += 1
    #         current_map[i][i] = 0
    #         usage_record.extend(['A', str(i), str(i)])
    #         if usages >= 30:
    #             print('Used all individualities')
    #             break
    ...
    while not found_destination:
        ...
        for finished_move in [move for move in possible_movements
            ...
            print(finished_move)
            write_result_to_file(finished_move.path, 'output3.txt')
